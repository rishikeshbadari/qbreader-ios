...
Read [AGENTS.md](../../AGENTS.md) before starting if you don't already have it in context — it lists fragile areas and hard rules.
...
- **Never** run `expo run:ios` (5+ min native rebuild — see AGENTS.md hard rules).
